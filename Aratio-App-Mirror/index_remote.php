...
// Verificar autenticación para el resto de la aplicación
requireAuth();
...
// Páginas permitidas (incluye las nuevas)
$paginasPermitidas = [
                ...
                <div class="relative">
                    <button @click="open = !open" class="flex items-center gap-3">
                        <div class="w-10 h-10 bg-gradient-to-br from-primary to-secondary rounded-full flex items-center justify-center">
                            <span class="text-white font-bold"><?= mb_substr($user['nombre'], 0, 1, 'UTF-8') ?></span>
                        </div>
        ...
        <div class="p-6 h-full overflow-y-auto">
            ...
            <div class="mb-6">
                ...
                <nav class="space-y-1">
                    ...
                    <a href="?page=colaboradores_red" class="flex items-center gap-3 px-4 py-3 rounded-lg <?= $pagina === 'colaboradores_red' ? 'bg-primary/10 text-primary' : 'text-gray-600 hover:bg-gray-50' ?>">
                        <i data-lucide="network" class="w-5 h-5"></i>
                        <span class="text-sm">Red Jerárquica</span>
                    </a>
