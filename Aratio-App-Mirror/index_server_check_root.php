...
// Autoloader manual simple (PSR-4 compatible para App\)
spl_autoload_register(function ($class) {
    ...
    // Reemplazar el prefijo con el directorio base, reemplazar separadores de namespace
    // con separadores de directorio y añadir .php
