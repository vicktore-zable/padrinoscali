...
$campana = $campana ?? [];
$pageTitle = 'Editar: ' . ($campana['nombre'] ?? '');
$old = $_SESSION['old_input'] ?? $campana;
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-600">Actualice la información de la campaña</p>
        </div>
    ...
    <!-- Formulario -->
    <form action="/campanas/<?= $campana['id'] ?>/update" method="POST" class="space-y-6">
        <?= Security::csrfField() ?>
