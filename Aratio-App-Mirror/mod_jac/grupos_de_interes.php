...
<?php endif; ?>
    ...
    <div class="md:hidden fixed top-0 left-0 right-0 z-[2000] p-4 flex justify-between items-center glass border-b border-gray-800">
        <div class="flex items-center gap-2">
            ...
            <span class="font-bold text-lg text-gold tracking-wide">ENTIDADES / ORGANIZACIONES</span>
        </div>
    ...
    >
        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-5 custom-scroll">
            ...
            <!-- Sector / Comuna -->
            <div class="space-y-2">
                <label class="text-xs font-semibold text-magenta uppercase tracking-wider">Comuna / Corregimiento</label>
                <div class="relative">
    ...
    <script>
        ...
        async function loadGruposInteres(filters) {
            ...
            try {
                ...
                const res = await fetch(`../api/jac.php?${queryParams.toString()}`);
                const json = await res.json();
        ...
        function featStyle(feature) {
            return {
                fillColor: '#3b82f6', // Pintar de azul solicitado por el usuario
                weight: 2,
                opacity: 1,
                color: '#1e3a5f',
                dashArray: '3',
