...
<div class="space-y-6" x-data="eventosData()">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="stat-card rounded-3xl border border-gray-100 hover:-translate-y-1 transition-transform duration-300">
            <div class="flex items-center justify-between mb-4">
                <div class="p-3 bg-primary/10 rounded-2xl">
                    <i data-lucide="calendar" class="w-6 h-6 text-primary"></i>
                </div>
            </div>
            <h3 class="text-3xl font-black text-[#0f172a] mb-1">
                <?= number_format($stats['total'] ?? 0) ?>
            </h3>
            <p class="text-xs uppercase tracking-wider font-bold text-gray-500">Total Eventos</p>
        </div>
        ...
        <div class="stat-card rounded-3xl border border-gray-100 hover:-translate-y-1 transition-transform duration-300">
            ...
            <p class="text-xs uppercase tracking-wider font-bold text-gray-500">Total Asistentes</p>
        </div>
        ...
        <div class="stat-card rounded-3xl border border-gray-100 hover:-translate-y-1 transition-transform duration-300">
            ...
            <p class="text-xs uppercase tracking-wider font-bold text-gray-500">Programados</p>
        </div>
        ...
        <div class="stat-card rounded-3xl border border-gray-100 hover:-translate-y-1 transition-transform duration-300">
            ...
            <p class="text-xs uppercase tracking-wider font-bold text-gray-500">Finalizados</p>
        </div>
    </div>
    ...
    <div class="space-y-6">
        <!-- Mapa -->
        <div class="card rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            <div class="flex items-center justify-between mb-6 p-2">
                <h3 class="text-2xl font-black text-[#0f172a] tracking-tight">Georreferenciación</h3>
                <div class="flex gap-2">
                    <span class="badge badge-primary">Mapa en Vivo</span>
                </div>
            </div>
            <div id="mapaEventos" class="h-[500px] z-10 border-4 border-white shadow-inner" style="height: 500px; border-radius: 32px;"></div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 flex flex-col gap-4">
                <div class="bg-gradient-to-br from-[#0f172a] to-[#1e293b] rounded-3xl p-6 text-white shadow-xl relative overflow-hidden flex-1">
                    <div class="relative z-10">
                        <h4 class="text-xl font-bold mb-2">Resumen Operativo</h4>
                        <p class="text-gray-400 text-sm mb-4">Métricas clave de ejecución en territorio para la campaña actual.</p>
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-white/5 p-4 rounded-2xl">
                                <p class="text-2xl font-bold text-primary">Cali</p>
                                <p class="text-xs text-gray-400">Municipio Principal</p>
                            </div>
                            <div class="bg-white/5 p-4 rounded-2xl">
                                <p class="text-2xl font-bold text-secondary">Valle</p>
    ...
    function eventosData() {
        return {
            ...
            verQR(id) {
                ...
                this.urlRegistro = window.location.href.split('?')[0].replace('index.php', '').replace(/\/$/, '') + '/registro_asistencia.php?evento=' + id;
                this.modalQR = true;
            ...
            async verAsistencia(id) {
                ...
                try {
                    const response = await fetch(`api/asistencia_eventos.php?evento_id=${id}`);
