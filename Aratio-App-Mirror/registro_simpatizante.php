...
<head>
    ...
    <title>Registro de Simpatizantes | Edison Giraldo</title>
    <meta name="description" content="Súmate como simpatizante al equipo de Edison Giraldo. Juntos transformaremos Cali.">
    ...
    <div class="bg-primary text-white pb-32 pt-16 px-6 hero-shape relative overflow-hidden">
        ...
        <div class="w-full mx-auto text-center relative z-10 px-4 md:px-12">
            ...
            <p class="text-lg md:text-xl text-slate-300 font-light max-w-2xl mx-auto mb-8">
                Regístrate y apoya la visión de Edison Giraldo para transformar nuestra ciudad.
            </p>
        ...
        <div class="bg-white rounded-[2.5rem] shadow-2xl p-10 max-w-md w-full text-center relative overflow-hidden"
            ...
            <div class="relative">
                ...
                <p class="text-slate-600 mb-10 leading-relaxed">
                    Gracias por unirte al equipo de <span class="font-bold text-primary">Edison Giraldo</span>. Tus datos han sido registrados correctamente como simpatizante.
                </p>
