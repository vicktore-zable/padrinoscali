...
Upload-FtpFile -localFile "diag_portal.php" -remotePath "domains/aratio.mrmtech.net/public_html/diag_portal.php"
Write-Host "Probar: https://aratio.mrmtech.net/diag_portal.php" -ForegroundColor Cyan
