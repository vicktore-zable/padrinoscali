...
Upload-FtpFile -localFile "diagnostico_completo.php" -remotePath "domains/aratio.mrmtech.net/public_html/diagnostico_completo.php"
Write-Host "Ejecutar: https://aratio.mrmtech.net/diagnostico_completo.php" -ForegroundColor Cyan
