...
Write-Host "Subiendo .htaccess a produccion..." -ForegroundColor Yellow
Upload-FtpFile -localFile "htaccess_production.txt" -remotePath "domains/aratio.mrmtech.net/public_html/.htaccess"
