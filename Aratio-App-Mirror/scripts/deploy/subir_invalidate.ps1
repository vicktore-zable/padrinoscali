# Subir script para invalidar cache
...
Upload-FtpFile -localFile "invalidate_cache.php" -remotePath "domains/aratio.mrmtech.net/public_html/invalidate_cache.php"
Write-Host "Ejecutar: https://aratio.mrmtech.net/invalidate_cache.php" -ForegroundColor Cyan
