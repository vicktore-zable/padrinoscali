...
Upload-FtpFile -localFile "phpinfo.php" -remotePath "domains/aratio.mrmtech.net/public_html/phpinfo.php"
Write-Host "Probar: https://aratio.mrmtech.net/phpinfo.php" -ForegroundColor Cyan
