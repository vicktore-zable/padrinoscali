# Script PowerShell para subir archivos del Portal de Líderes a Hostinger via FTP (automático)
...
# Función para crear directorio remoto si no existe
function Ensure-FtpDirectory {
    ...
    try {
        ...
        Write-Host "  Directorio existe: $remotePath" -ForegroundColor DarkGray
    }
}
...
Ensure-FtpDirectory "domains/aratio.mrmtech.net/public_html/mod_lider"
Ensure-FtpDirectory "domains/aratio.mrmtech.net/public_html/mod_lider/src"
Ensure-FtpDirectory "domains/aratio.mrmtech.net/public_html/mod_lider/src/Models"
Write-Host ""
...
Write-Host "Iniciando subida automatica..." -ForegroundColor Yellow
Write-Host ""
