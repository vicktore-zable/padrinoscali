...
Upload-FtpFile -localFile "reset_opcache.php" -remotePath "domains/aratio.mrmtech.net/public_html/reset_opcache.php"
Write-Host "Ejecutar: https://aratio.mrmtech.net/reset_opcache.php" -ForegroundColor Cyan
