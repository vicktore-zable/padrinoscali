...
Upload-FtpFile -localFile "test_prod.php" -remotePath "domains/aratio.mrmtech.net/public_html/test_prod.php"
Write-Host "Probar: https://aratio.mrmtech.net/test_prod.php" -ForegroundColor Cyan
