...
print("--- api/campanas.php ---")
print(stdout.read().decode('utf-8'))

# También revisar logs recientes
stdin, stdout, stderr = client.exec_command(f"tail -n 50 /home/u577647812/domains/edisongiraldo.com/public_html/php-errors.log")
