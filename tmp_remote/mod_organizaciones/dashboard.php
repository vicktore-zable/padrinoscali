                ...
                <div class="space-y-5">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select x-model="filters.sector" @change="fetchBarrios" :disabled="!filters.municipio" class="w-full bg-slate-50 border border-slate-200 text-primary font-bold text-sm rounded-2xl p-4 outline-none focus:ring-4 focus:ring-secondary/10 transition-all appearance-none cursor-pointer disabled:opacity-50">
                    ...
                    <div class="pt-4 border-t border-gray-100">
                        <div class="bg-gradient-to-br from-primary to-slate-900 rounded-3xl p-5 text-white shadow-2xl relative overflow-hidden group">
...
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('organizacionesDashboard', () => ({
        ...
        dropdowns: { municipios: [], sectores: [], barrios: [] },
        mapStats: { organizaciones: 0 },
        ...
        async fetchTipos() {
            ...
            try {
                const res = await fetch(`${API_BASE}territorios.php?accion=territorios&departamento=${encodeURIComponent(this.filters.departamento)}&municipio=${encodeURIComponent(this.filters.municipio)}&tipo_territorio=COMUNA`);
                const json = await res.json();
                if(json.success) this.dropdowns.sectores = json.data;
            } catch(e) { console.error(e); }
        },

        fetchBarrios() { this.fetchMapaData(); },
        ...
        async fetchMapaData() {
            ...
            try {
                ...
                if (json.success) {
                    ...
                    this.renderMapItems();
                    this.mapStats.organizaciones = this.mapData.length;
                }
            } catch (e) { console.error(e); }
        ...
        get filteredMapData() {
            if (!this.searchTerm) return this.mapData;
            if (this.searchTerm.length < 3) return this.mapData;
